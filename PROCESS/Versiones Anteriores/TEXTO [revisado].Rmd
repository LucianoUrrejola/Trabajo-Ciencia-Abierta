...
#### *__1. Pregunta y objetivos de investigación__*

*__Pregunta de investigación:__*
...
AQUI VA LA TAB?A 5 PRUEBA CHICUADRADO Y tamaño DEL EFECTO CON V DE CRAMER PARA REMUNERACION
...
A partir de la Tabla 8, se puede identificar la relación entre clase social y estrategia de cuidado para la persona encargada principalmente de cuidado. En primer lugar se observa, al igual que en los análisis generales de la muestra, que no hay hombres que cumplan con el rol de hacerse cargo principalmente del cuidado, lo que implica que las estrategias "Hombre con remuneración" y "Hombre sin remuneración" no están presentes en la tabla. Es decir, un elemento común a las distintas clases sociales, es que son mujeres las que se hacen cargo mayoritariamente del cuidado, por lo que se puede inferir que, independiente la clase social, los hombres no se hacen cargo del cuidado.
...
Si se considera la remuneración anterior desde una muestra probabilísticamente construida, sería posible generar inferencias poblacionales a partir de esta. 
...
El constructo principal de la investigación corresponde a la variable dependiente de la hipótesis principal, el cual es "Estrategias de Cuidado", entendidas como las formas de hacerse cargo del cuidado, se dividirán en tres dimensiones: (i) características de quien decide sobre el cuidado, que refiere a las características de la persona que se hace cargo de las planificaciones/decisiones del cuidado del niño/a/e; (ii) características del cuidador/a principal, y que se orienta a describir el perfil del cuidador en tanto cuidador. Se entiende por cuidador como la persona que se hace cargo mayormente del niño/a desde la gestación hasta los 8 años [@unesco2017]; (iii) distribución según Género de las tareas de cuidado, orientado a saber cuál es la asignación de las tareas de cuidado del niño/a en Relación con el Género. Para efectos del análisis, se entenderá que las estrategias de cuidado están compuestas por el Género y la remuneración de la persona (dentro de las distintas dimensiones en las que se puede evaluar una estrategia de cuidado). Así, existirán cuatro tipos de estrategias de cuidado: 1. Mujer con remuneración, 2. Mujer sin remuneración, 3. Hombre con remuneración, 4. Hombre sin remuneración.
Por otro lado, se entenderá clase social como posicin de las personas dentro del espacio social según su lugar en el sistema económico [@web1993]. Operativamente, en el presente trabajo estará dada por el nivel de ingresos y de escolaridad de las y los apoderados del establecimiento educacional y el porcentaje de niñas y niños en condición de vulnerabilidad. Siendo "alto" un establecimiento en que "La mayoría de los apoderados ha declarado tener 16 o más años de escolaridad y un ingreso del hogar de \$1.460.001 o más." y "9% o menos de los estudiantes se encuentra en condición de vulnerabilidad social."; "medio" uno en que "La mayoría de los apoderados ha declarado tener entre 12 y 13 años de escolaridad y un ingreso del hogar que varía entre \$490.001 y \$740.000." y "Entre 36,01% y 54% de los estudiantes se encuentra en condición de vulnerabilidad social." ; y "bajo" un establecimiento que "La mayoría de los apoderados ha declarado tener entre 10 y 11 años de escolaridad y un ingreso del hogar que varía entre \$290.001 y \$460.000." y "Entre 57,01% y 75% de los estudiantes se encuentra en condición de vulnerabilidad social." [@ace2017]
...
2. Se pasarán las respuestas de remuneración a números para la sistematización de estas. La respuestas que indican que se recibe remuneración pasarán a ser 1 y las que indican que  no se recibe remuneración (No) pasarán a ser 2, referentes a las pregunta 10. 

3. Se recodificarán las respuestas de la pregunta 10 y 12 de manera combinada, para generar la variable "Estrategia de Cuidado" con los códigos 1: Mujer con remuneración, 2: Mujer sin remuneración, 3: Hombre con remuneración, 4: Hombre sin remuneración. 
